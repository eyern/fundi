...
def category(request):
    ...
    if request.method == 'POST':
        ...
        your_message = "Your trusted interior design company - Fundi"
        subject = "Fundi updates"
...
def about(request):
    # Renders the template 'home.html' from your templates folder
    return render(request, 'product_app/about.html', {'about': about})

def services(request):
    # Renders the template 'home.html' from your templates folder
    return render(request, 'product_app/services.html', {'services': services})